...
fileLocalTrain <- "pml-training.csv"
fileURLTest <- "https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv"
fileLocalTest <- "pml-testing.csv"


if(!file.exists(fileLocalTrain)){
  download.file(fileURLTrain, fileLocalTrain)
}
if(!file.exists(fileLocalTest)){
  download.file(fileURLTest, fileLocalTest)
}
